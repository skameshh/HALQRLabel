...
{
    public partial class FormICIMarking : Form
    {
        public static readonly log4net.ILog log = log4net.LogManager.GetLogger(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType);
        //private static string PRINTER_NAME ="Brother PT-P900W";
        //private static string PRINTER_NAME_NW = "Brother PT-P950NW";

        public FormICIMarking()
        {
            InitializeComponent();
            updateSeq();
        }
        ...
        private const string TEMPLATE_36mm = "ici_marking_36.lbx";
